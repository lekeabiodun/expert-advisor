...
void TakeTrade(ENUM_MARKET_ENTRY Entry) 
{
    ...
    {
        double ask                              = NormalizeDouble(SymbolInfoDouble(Symbol(), SYMBOL_ASK), _Digits);
        double sl                                = NormalizeDouble(ask - (StopLoss / MathPow(10, _Digits)), _Digits);
        double tp                              = NormalizeDouble(ask + (TakeProfit / MathPow(10, _Digits)), _Digits);
    ...
    {
        double bid                              = NormalizeDouble(SymbolInfoDouble(Symbol(), SYMBOL_BID), _Digits);
        double sl                               = NormalizeDouble(bid + (StopLoss / MathPow(10, _Digits)), _Digits);
        double tp                               = NormalizeDouble(bid - (TakeProfit / MathPow(10, _Digits)), _Digits);
        trade.SetExpertMagicNumber(EXPERT_MAGIC);
