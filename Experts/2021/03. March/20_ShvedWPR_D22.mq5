...
void OnTick() 
{
    ...
    if(new_zone == 4 && PrevTradeZoneHigh != ResistantZoneHigh && PrevTradeZoneLow != ResistantZoneLow && WPR_Signal(MARKET_ENTRY_SHORT))
    {
    ...
    if(new_zone == 5 && PrevTradeZoneHigh != SupportZoneHigh && PrevTradeZoneLow != SupportZoneLow && WPR_Signal(MARKET_ENTRY_LONG))
    {
...
bool WPR_Signal(ENUM_MARKET_ENTRY Signal)
{
