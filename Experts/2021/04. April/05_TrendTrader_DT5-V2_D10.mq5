...
double StochasticLastPrice = 0;
double StochasticNewPrice = 0;
...
bool StochasticSignal()
{
    ...
    StochasticNewPrice = StochValue0;

    if(StochasticNewPrice > StochOverSoldLevel && StochasticLastPrice < StochOverSoldLevel) 
    { 
    ...
    if(StochasticNewPrice < StochOverBoughtLevel && StochasticLastPrice > StochOverBoughtLevel) 
    { 
    ...
    StochasticLastPrice = StochasticNewPrice;
