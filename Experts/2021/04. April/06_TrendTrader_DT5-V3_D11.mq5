...
void OnTick() 
{
    ...
    if(LowerTimeframeSignal(MARKET_ENTRY_SHORT) && HigherTimeframeSignal(MARKET_ENTRY_SHORT))
    {
        TakeTrade(MARKET_ENTRY_SHORT);
    }

    if(LowerTimeframeSignal(MARKET_ENTRY_LONG) && HigherTimeframeSignal(MARKET_ENTRY_LONG))
    {
