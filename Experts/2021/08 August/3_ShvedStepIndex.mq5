...
/*
# Strategy
When market hit a zone market will tend to break the zone or bounce back
*/
...
input int                                           ExpertMaxOpenPosition = 2; // Maximum open position
...
void OnTick() 
{
    if(PositionsTotal() >= ExpertMaxOpenPosition) { return; }
