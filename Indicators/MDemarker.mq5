...
//+--------------------------------------------------+
//| Параметры отрисовки индикатора StepDeMarker fast |
//+--------------------------------------------------+
//---- отрисовка индикатора 2 в виде линии
#property indicator_type2   DRAW_LINE
//---- в качестве цвета линии индикатора использован цвет LimeGreen
...
//---- отображение метки индикатора
#property indicator_label2  "StepDeMarker fast"
//+--------------------------------------------------+
//| Параметры отрисовки индикатора StepDeMarker slow |
//+--------------------------------------------------+
//---- отрисовка индикатора 3 в виде линии
#property indicator_type3   DRAW_LINE
//---- в качестве цвета линии индикатора использован цвет Red
...
//---- отображение метки индикатора
#property indicator_label3  "StepDeMarker slow"
//+--------------------------------------------------+
...
//---- копируем вновь появившиеся данные в массив
   if(CopyBuffer(DeMarker_Handle,0,0,to_copy,Line1Buffer)<=0) return(0);
   ...
   for(bar=limit; bar>=0 && !IsStopped(); bar--)
     {
      ...
      //----
      DeMarker0=Line1Buffer[bar]=Line1Buffer[bar]*100;
      //----
